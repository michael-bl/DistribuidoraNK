...
public class FacturacionContent extends AppCompatActivity {
    ...
    private void getProductosDeDbLocal() {
        try {
            conexiones = new Conexiones(FacturacionContent.this);
            ...
            Toast.makeText(FacturacionContent.this, "Error, verifique por favor: " + npe.getMessage(), Toast.LENGTH_LONG).show();
        } catch (JsonSyntaxException jse) {
            Toast.makeText(FacturacionContent.this, "Error, verifique por favor: " + jse.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
            ...
            requestProductos.enqueue(new Callback<JsonArray>() {
                ...
                public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                    if (!response.isSuccessful()) {
                        Toast.makeText(FacturacionContent.this, response.message() + "Error al cargar datos!", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        llenarListViewProductos(stringIdsListaProductos, listaProductos);
                        Toast.makeText(FacturacionContent.this, "Datos cargados exitosamente!", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onFailure(Call<JsonArray> call, Throwable t) {
                    Toast.makeText(FacturacionContent.this, "La peticion falló: " + t.toString(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            Toast.makeText(FacturacionContent.this, "El dispositivo no puede accesar a la red en este momento!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void onTextChanged() {
        ...
        tvBuscarProducto = findViewById(R.id.txtBuscarContentFactura);
        tvBuscarProducto.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                listviewProductos.setAdapter(new SelectionAdapter(FacturacionContent.this, android.R.layout.simple_list_item_1, android.R.id.text1, array_sort));
            }
        ...
        listviewProductos.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                ...
                if (item.getItemId() == R.id.delete) {
                    Toast.makeText(FacturacionContent.this,
